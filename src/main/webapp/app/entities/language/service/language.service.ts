...
export class LanguageService {
  ...
  update(language: ILanguage): Observable<EntityResponseType> {
    return this.http.put<ILanguage>(`${this.resourceUrl}/${getLanguageIdentifier(language) as string}`, language, { observe: 'response' });
  }

  partialUpdate(language: ILanguage): Observable<EntityResponseType> {
    return this.http.patch<ILanguage>(`${this.resourceUrl}/${getLanguageIdentifier(language) as string}`, language, {
      observe: 'response',
    });
  }

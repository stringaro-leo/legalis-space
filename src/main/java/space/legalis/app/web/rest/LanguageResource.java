...
/**
 * REST controller for managing {@link space.legalis.app.domain.Language}.
 */
@RestController
@RequestMapping("/api")
public class LanguageResource {
    ...
    public List<Language> getAllLanguages(@RequestParam(required = false) String filter) {
        if ("translation-is-null".equals(filter)) {
            log.debug("REST request to get all Languages where translation is null");
            return languageService.findAllWhereTranslationIsNull();
        }

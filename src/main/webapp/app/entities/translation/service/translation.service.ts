...
export class TranslationService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/translations');
  ...
  update(translation: ITranslation): Observable<EntityResponseType> {
    return this.http.put<ITranslation>(`${this.resourceUrl}/${getTranslationIdentifier(translation) as string}`, translation, {
      observe: 'response',
    });
  }

  partialUpdate(translation: ITranslation): Observable<EntityResponseType> {
    return this.http.patch<ITranslation>(`${this.resourceUrl}/${getTranslationIdentifier(translation) as string}`, translation, {
      observe: 'response',
    });
  }
